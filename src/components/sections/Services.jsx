...
const SERVICES = [
  ...
  },
  {
    ...
    kind: 'Fuel program',
    title: 'Fuel Card',
    desc: 'Prepaid, cardless fueling at major truck stops — real savings on every gallon. Coming soon.',
    points: ['Cardless fueling', 'Nationwide truck stops', 'Prepaid spend control'],
    price: '70¢',
    priceUnit: '/ gal',
